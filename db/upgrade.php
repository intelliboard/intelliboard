...
function xmldb_local_intelliboard_upgrade($oldversion) {
    ...
    if ($oldversion < 2018091502) {
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('userid', XMLDB_TYPE_CHAR, '200', null, null, null, null);
    ...
    if ($oldversion < 2018092602) {
		...
		upgrade_plugin_savepoint(true, 2018092602, 'local', 'intelliboard');
	}

    if ($oldversion < 2018092605) {
        $table = new xmldb_table('local_intelliboard_ntf');
        ...
        upgrade_plugin_savepoint(true, 2018092605, 'local', 'intelliboard');
    }

		if ($oldversion < 2018100102) {
			$data = [];
				$table = new xmldb_table('local_intelliboard_assign');
				if ($dbman->table_exists($table)) {
					$data = $DB->get_records("local_intelliboard_assign");
			...
			upgrade_plugin_savepoint(true, 2018100102, 'local', 'intelliboard');
    }
