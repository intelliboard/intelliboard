...
<div class="intelliboard-support">
    ...
    <?php if (!get_config("local_intelliboard", "te1")): ?>
        <div class="intelliboard-support-text">
            <p><?php echo get_string('support_text3', 'local_intelliboard', ["connect_link" => $connectlink->out()]); ?></p>
        </div>
        <div class="intelliboard-support-links connect-upgrade">
            <a class="intelliboard-support-btn" href="<?php echo $connectlink->out(); ?>">
