...
$string['support_text3'] = 'Добро пожаловать в IntelliBoard! Учреждения по всему миру используют IntelliBoard для отслеживания прогресса учащихся, контроля выполнения заданий и лучшего взаимодействия. Все ваши данные LMS в легко извлекаемых, интуитивно понятных, и привлекательных отчетах, и графиках.';
$string['support_text4'] = 'Плагин IntelliBoard помогает принимать информированные решения в образовательном процессе на основе данных непосредственно Вашей LMS в режиме реального времени.';
