...
$string['filter4_desc'] = 'Mostrar cursos não visíveis';
...
$string['t04'] = 'Ativar [header] Cursos concluídos';
$string['t05'] = 'Ativar [header] Cursos em andamento';
$string['t06'] = 'Ativar [header] Nota média de cursos';
...
$string['t42'] = 'Ativar [Activity Grades header] Último acesso ao curso';
...
$string['last_access_on_course'] = 'Último acesso ao curso: {$a}';
...
$string['my_course_average_all'] = 'Minha média do curso (Todos os cursos)';
...
$string['score'] = 'Nota';
$string['course_completion_status'] = 'Status de conclusão do curso';
...
$string['courses_avg_grade'] = 'Nota média dos cursos';
...
$string['course_completions'] = 'Conclusão de cursos';
...
$string['total_values_include'] = 'Valores Totais incluem sessões exclusivas, cursos, visitas, tempo gasto.';
...
$string['course_started'] = 'Curso Começado';
...
$string['course_overview'] = 'Visão Geral do Curso';
...
$string['a38'] = 'Cursos Vinculados a Competências';
...
$string['a11'] = 'Lista de competências atribuídas ao curso';
...
$string['a26'] = 'Esta tabela exibe o número de competências atribuídas a um curso, alunos que foram classificados (sejam aptos ou não) e alunos que foram designados aptos na competência.';
...
$string['widget_name30'] = "Inscrições por Curso";
...
$string['not_quiz'] = "Ops, parece que você não tem nenhum teste criado para o curso selecionado.";
...
$string['course_chart'] = 'Ativar gráfico do curso';
...
$string['course_max_grade'] = 'Nota máxima do curso';
...
$string['privacy:metadata:local_intelliboard_totals:timespend'] = 'Tempo total de usuários gastos no Moodle';
...
$string['privacy:metadata:local_intelliboard_tracking:timespend'] = 'Tempo gasto pelo utilizador na página';
...
$string['privacy:metadata:local_intelliboard_bbb_meet:cmid'] = 'ID do módulo de cursos';
...
$string['coursessessionspage'] = "Página de Sessões de Cursos";
$string['coursessessions'] = "Sessões de Cursos";
...
$string['viewed'] = "Visto";
$string['course'] = "Curso";
$string['courseaverage'] = "Média do Curso";
