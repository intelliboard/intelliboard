...
class provider implements
    ...
    public static function get_metadata(collection $collection) {
        ...
        $collection->add_database_table('local_intelliboard_reports', [
        ...
        $collection->add_database_table('local_intelliboard_bbb_meet', [
        ...
        $collection->add_database_table('local_intelliboard_bbb_atten', [
        ...
        $collection->add_database_table('local_intelliboard_bb_partic', [
        ...
        $collection->add_database_table('local_intelliboard_bb_trck_m', [
        ...
        $collection->add_database_table('local_intelliboard_att_sync', [
        ...
        $collection->add_database_table('local_intelliboard_trns_c', [
        ...
        // The 'local_intelliboard_trns_c' table stores the metadata about course actions.
        $collection->add_database_table('local_intelliboard_trns_m', [
