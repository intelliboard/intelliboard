    ...
    public function report21($params)
    {
        ...
        return $this->get_report_data("
            SELECT t.*,
                ...
                $sql_columns
                FROM (SELECT MIN(id) AS id,userid, scormid, timemodified,
